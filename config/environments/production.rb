...
Rails.application.configure do
  ...
  # Ensure proper header handling for CSRF tokens
  ...
  config.action_mailer.default_url_options = { host: "gleania.com" }

  # Ignore bad email addresses and do not raise email delivery errors.
  # Set this to true and configure the email server for immediate delivery to raise delivery errors.
  # config.action_mailer.raise_delivery_errors = false
  config.action_mailer.delivery_method = :postmark
  config.action_mailer.postmark_settings = { api_token: Rails.application.credentials.dig(:postmark, :api_token) || ENV["POSTMARK_API_TOKEN"] }
  ...
  config.hosts = [
    "gleania.com"  # Allow requests from gleania.com only
  ]
  #
