...
# AiExtractionLog model for tracking AI extraction calls
#
# Stores detailed information about every AI extraction attempt including
# full request/response payloads, token usage, costs, and performance metrics.
# This enables debugging, cost tracking, and performance analysis.
#
# @example
...
#     status: :success
#   )
class AiExtractionLog < ApplicationRecord
  ...
  belongs_to :prompt_template, class_name: "ExtractionPromptTemplate", optional: true
